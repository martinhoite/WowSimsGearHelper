...
local function PopulateGuide(parent, cursorY, width)
  ...
  _, cursorY = AddTextBlock(parent, cursorY, "4. Review the plan by hovering rows, warnings, socket icons, and shopping entries.", "GameFontHighlightSmall", width, 0, 4, textColor)
  ...
  _, cursorY = AddTextBlock(parent, cursorY, "Most warnings and status icons have extra detail in their tooltips.", "GameFontNormalSmall", width, 2, 8, noteColor)
